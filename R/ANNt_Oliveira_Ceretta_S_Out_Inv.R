...
#' Plot_BS = ''
#' Plot_CF=''
#'ANNt_Oliveira_Ceretta_S_Out_Inv(c('AAPL','XOM','TSLA','KO', 'F'), '^GSPC', 0,
...
InvestmentValuation::Gen_Portfolios_Inv(Portfolios=c('Magic_Formula', 'Intelligent_Investor'),N_Assets='n_Assets',Initial_Date_Testing=Initial_Date,Final_Date_Testing=Final_Date_Training,'x5', type_ANNt=Type_ANNt, Out='Yes')
